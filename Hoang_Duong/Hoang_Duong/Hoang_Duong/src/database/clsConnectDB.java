...
public class clsConnectDB {
    String connectionString = "jdbc:sqlserver://DESKTOP-G64NA9A\\SQLTEST:1433;"
        + "databaseName=QuanLySanPham;user=sa;password=123;encrypt=true;trustServerCertificate=true;";
